...
var CallerId = /** @class */ (function (_super) {
    __extends(CallerId, _super);
    function CallerId(prv, id, service) {
        return _super.call(this, "caller-id", id, prv, service) || this;
    }
    /**
     ...
     *  return {ApiResponse}
     */
    CallerId.prototype.getRaw = function () {
        return this._send({
            body: undefined,
            ignoreId: true,
            method: "get",
     ...
     */
    CallerId.prototype.put = function (body) {
        return this._send({
            body: body,
            ignoreId: true,
            method: "put",
     ...
     *  return {ApiResponse}
     */
    CallerId.prototype.putRaw = function (body) {
        return this._send({
            body: body,
            ignoreId: true,
            method: "put",
