...
export class ExtensionCallLogRecord extends model.Model {
     ...
     * Call type
     */
    type:ExtensionCallLogRecordType;

    /**
     * Call direction
     */
    direction:ExtensionCallLogRecordDirection;

    /**
     * Action description of the call operation
     */
    action:ExtensionCallLogRecordAction;

    /**
     * Status description of the call operation
     */
    result:ExtensionCallLogRecordResult;
...
export enum ExtensionCallLogRecordType {
    Voice = <any>'Voice',
    Fax = <any>'Fax'
}

export enum ExtensionCallLogRecordDirection {
    Inbound = <any>'Inbound',
    Outbound = <any>'Outbound'
}

export enum ExtensionCallLogRecordAction {
    Unknown = <any>'Unknown',
...
export enum ExtensionCallLogRecordResult {
    Unknown = <any>'Unknown',
