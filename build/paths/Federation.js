...
var Federation = /** @class */ (function (_super) {
    ...
    function Federation(prv, id, service) {
        return _super.call(this, "federation", id, prv, service) || this;
    }
    /**
     ...
     */
    Federation.prototype.get = function () {
        return this._send({
            body: undefined,
            ignoreId: true,
            method: "get",
     ...
     *  return {ApiResponse}
     */
    Federation.prototype.getRaw = function () {
        return this._send({
            body: undefined,
            ignoreId: true,
            method: "get",
